...
import RecruiterHistory from './pages/recruiter/InterviewHistory';
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/recruiter/history" element={<PrivateRoute role="recruiter"><RecruiterHistory /></PrivateRoute>} />
      <Route path="/recruiter/notifications" element={<PrivateRoute role="recruiter"><RecruiterNotifications /></PrivateRoute>} />
